...
def build33():
    ...
    new_room(0,3,'Прихожая','Вход',True,None,[[6.18+0.09,4.38-0.09],[7.88,4.38-0.09],[7.88,2.5],[6.18+0.09,2.5]])
    ...
    new_room_node(0,    10,  4-1,      2-0.5,     2)

    new_room_node(0,    7,  7,      3.5,     3)


    new_door_node(0, 6,1.97,6.98-1.5,0,1,0)


    new_door_node(0, 8,6.18+0.09/2,(3.44+4.38)/2,3,1,180)
    new_door_node(0, 9,6.18+0.09/2,(3.35+2.5)/2,3,2,180)
...
def build36():
    ...
    new_room(0,0,'Балкон 1Э','Место для отдыха',True,None,[[1,6.98],[1.93,6.98],[1.93,1],[1,1]])
    new_room(0,1,'Комната 1Э','Главная комната для тестирования',True,None,[[2.02,6.98],[7.88,6.98],[7.88,4.38],[6.18,4.38],[6.18,3.44],[2.02,3.44]])
    #new_room(0,2,'Кухня 1 этаж','Помещение для еды',True,None,[[2.02,3.35],[6.18,3.35],[6.18,1],[2.02,1]])
    new_room(0,3,'Прихожая 1Э','Вход',True,None,[[6.18+0.09,4.38-0.09],[7.88,4.38-0.09],[7.88,2.5],[6.18+0.09,2.5]])
    ...
    new_qr(0,           3,  1+0.93/2,      1,   270,    0,0)
    new_qr(0,           4,  3,      1,   270,    2,0)
    new_qr(0,           5,  7.5,      4.38-0.09,   90,    3,0)
    ...
    #new_room(1,4,'Балкон 2 этаж','Место для отдыха',True,None,[[1,6.98],[1.93,6.98],[1.93,1],[1,1]])
    new_room(1,5,'Комната 2Э','Главная комната для тестирования',True,None,[[2.02,6.98],[7.88,6.98],[7.88,4.38],[6.18,4.38],[6.18,3.44],[2.02,3.44]])
    new_room(1,6,'Кухня 2Э','Помещение для еды',True,None,[[2.02,3.35],[6.18,3.35],[6.18,1],[2.02,1]])
    new_room(1,7,'Прихожая 2Э','Вход',True,None,[[6.18+0.09,4.38-0.09],[7.88,4.38-0.09],[7.88,2.5],[6.18+0.09,2.5]])

    new_room_node(1,    10,  3.3,      5.5,     5)
    new_room_node(1,    11,  6.44,      5.5,     5)
    new_room_node(1,    12,  4.8,      4.3,     5)
    new_room_node(1,    13,  6.17,      4.5,     5)

    #new_room_node(1,    14,  1.5,      3.0,     4)


    new_room_node(1,    20,  4-1+0.5,      2,     6)

    new_room_node(1,    17,  7,      3.5,     7)


    #new_door_node(1, 16,1.97,6.98-1.5,0,1,4)


    new_door_node(1, 18,6.18+0.09/2,(3.44+4.38)/2,7,5,180)
    new_door_node(1, 19,6.18+0.09/2,(3.35+2.5)/2,7,6,180)
 ...
 #   new_edge(14,16)
    ...
    new_qr(1,           6,  4.76-0.4,      6.0,     90,      5,0)
    new_qr(1,           7,  2.95,      3.44,     270,      5,0)
    new_qr(1,           8,  7.88,      5.3,   0,    5,0)
    new_qr(1,           9,  1+0.93/2,      1,   270,    4,0)
    new_qr(1,           10,  3,      1,   270,    6,0)
    new_qr(1,           11,  7.5,      4.38-0.09,   90,    7,0)
    ...
    new_portal(0,       25, 7,     2.5,     'elevator',270,3)
    ...
    new_portal(1,       35, 7,     2.5,     'elevator',270,7)
    new_portal(1,       36, 2.02,      2.2,      'staircase',180,6,[1,2.5])
    new_edge(35,17)
    new_edge(35,19)
    new_edge(36,20)
    new_edge(36,19)
